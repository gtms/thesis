...
the genetic networks supporting the essential functionalities for multicellular
life may lack the degrees of redundancy and resiliency of those representing
...
Once this discretization between germinal and somatic lineages was achieved, the
evolution of complexity in multicellular organisms then became a function of the
...
discussed so far has been proposed by Grosberg and
...
(\emph{e})~sexual reproduction emerges involving the production, through
meiosis, of haploid gametes and their posterior fusion;
(\emph{f})~multicellular organisms evolve from unicellular ancestors; and
(\emph{g})~social groups composed of discrete multicellular individuals become
established.

All throughout theses transitions, major forces were at play knitting the
tapestry of life---prime among which was natural selection.  The scientific
argument for the theory of evolution through means of natural selection is
three-pronged: (\emph{a})~more offspring are produced than can possibly survive;
(\emph{b})~traits vary among individuals, leading to different rates of survival
and reproduction; and (\emph{c})~trait differences are heritable.

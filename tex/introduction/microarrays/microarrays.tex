...
cancer patients would be needed.
...
profile of the tumour.\footnote{``Even though you could look under the
  microscope and they all look the same (\ldots{}) some have built into them
  programs to become aggressive''---\emph{Stephen Friend}}

This approach not only produced the first genomic predictors to inform treatment
decisions, but, perhaps more interestingly, it also begged for their scrutiny
their eventual role in cancer progression.underlying was now possible to query
the biology of cancer progression by scrutinizing the biological of the lists of
genes derived from these studies.

...
algorithms.  Next, it will cover \smallcaps{roc} curves, a tool to evaluate the
...
Support vector machines, or \smallcaps{svm}, are an example of a
...
\smallcaps{rf}, are classifiers consisting of a collection of decision trees
...
\begin{marginfigure}%
    ...
    curve)]{Receiver operating characteristic curves (\smallcaps{roc}) are
      ...
      \smallcaps{auc}s on the same plot allows for direct comparison of
...
The area under the curve, or \smallcaps{auc} (0 < \smallcaps{auc} < 1),
...
test.\cite{hanley_meaning_1982}  The \smallcaps{auc} metric allows for direct
comparison of classifier performance.  A \smallcaps{auc} of 50\% represents a

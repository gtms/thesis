...
supervised learning techniques to the analysis of microarray data.
...
cancer (disease-free survival, or \smallcaps{dfs}).  Whenever the information
about an individual survival time is incomplete, that observation is said to be
censored.  This may be due because the event was not observed by the end of the
study (in which case the follow-up time considered for that patient is the
entire duration of the study) or because the patient quit the study before its
end (in which case the follow-up time considered for that patient is up to the
moment of leaving).
